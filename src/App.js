...
class App extends Component {
    state = {
        persons: [
            { id: "34535", name: "Max", age: 28 },
            { id: "ertt", name: "Manu", age: 29 },
            { id: "5353", name: "Stephanie", age: 26 }
        ],
    ...
    nameChangedHandler = (event, id) => {
        ...
        // const person = Object.assign({}, this.state.persons[personIndex]); alternative to using above spread operator.
